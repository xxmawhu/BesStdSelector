...
#   File Name     : BeSelectorKaonSelector.cxx
...
#include "BeSelector/Selector/BeSelectorKaonSelector.h"
BeSelectorKaonSelector::BeSelectorKaonSelector() {
    m_pidtype = 1;
    ...
    jobSvc->setMyProperties("BeSelectorKaonSelector", &m_propMgr);
}

bool BeSelectorKaonSelector::operator()(CDChargedKaon& aKaon) {
    aKaon.setUserTag(1);
