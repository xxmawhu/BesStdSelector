...
#   File Name     : BeSelectorSecondaryProtonSelector.cxx
...
#include "BeSelector/Selector/BeSelectorSecondaryProtonSelector.h"

BeSelectorSecondaryProtonSelector::BeSelectorSecondaryProtonSelector() {
    ...
    jobSvc->setMyProperties("BeSelectorSecondaryProtonSelector", &m_propMgr);
}

bool BeSelectorSecondaryProtonSelector::operator()(CDProton& aProton) {
